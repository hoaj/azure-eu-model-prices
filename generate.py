...
<div class="wrap">
  ...
  <div class="card">
    ...
    <table>
      <thead><tr>
        ...
        <th class="sortable hide" data-sort="reasoning" title="Default reasoning effort — set by Azure / the model. Cognigy's LLM Prompt Node has no reasoning control, so it inherits this default. Hover a model name for all options.">Default&nbsp;effort<span class="sub">reasoning</span> <span class="arr">↕</span></th>
  ...
  <div class="legend">
    ...
    <div class="box"><h4>Default effort</h4><p>Each model's default <a href="https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/reasoning" target="_blank" rel="noopener">reasoning_effort</a>, set by Azure / the model. Cognigy inherits it — its LLM Prompt Node has no reasoning control. Hover a model name for all options. <code>—</code> = not a reasoning model; <code>n/d</code> = default not documented by Microsoft.</p></div>
