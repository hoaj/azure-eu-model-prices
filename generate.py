...
<div class="wrap">
  ...
  <div class="card">
    ...
    <table>
      <thead><tr>
        ...
        <th class="sortable hide" data-sort="reasoning" title="The default reasoning effort Cognigy applies — its LLM Prompt Node has no reasoning control, so it uses each model's API default. Hover a model name for all options.">Cognigy&nbsp;default<span class="sub">reasoning effort</span> <span class="arr">↕</span></th>
  ...
  <div class="legend">
    ...
    <div class="box"><h4>Cognigy default (reasoning)</h4><p>The default <a href="https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/reasoning" target="_blank" rel="noopener">reasoning_effort</a> a model applies — what Cognigy's LLM Prompt Node uses, since it has no reasoning control. Hover a model name for all options. <code>—</code> = not a reasoning model; <code>n/d</code> = default not documented by Microsoft.</p></div>
